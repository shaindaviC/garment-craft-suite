...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Atelier ERP — Garment Manufacturing Management" },
      { name: "description", content: "Modern ERP for garment manufacturers: inventory, production tracking, orders, billing, analytics and AI stock intelligence." },
      { name: "author", content: "Atelier ERP" },
      { property: "og:title", content: "Atelier ERP — Garment Manufacturing Management" },
      { property: "og:description", content: "End-to-end garment manufacturing platform: fabric inventory, production, orders, billing and AI stock insights." },
